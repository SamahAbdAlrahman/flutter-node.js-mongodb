...
import '../configs.dart';
class addBeginnerExercises extends StatefulWidget {
  const addBeginnerExercises({super.key});



  @override
  State<addBeginnerExercises> createState() => _WorkoutDetailViewState();

}

class _WorkoutDetailViewState extends State<addBeginnerExercises> {
