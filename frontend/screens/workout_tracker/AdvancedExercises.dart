...
class AdvancedExercises extends StatefulWidget {
  const AdvancedExercises({super.key});
...
Widget _buildHeaderImage() {
  return Column(
    children: [
      ...
      Image.asset(
        "assets/img/1.png", // استبدل بمسار الصورة الفعلي
        width: 360,
        height:180,
        fit: BoxFit.cover,
      ),
      ...
      Text(
        'Perform squats by standing with feet shoulder-width apart, bending at the knees and hips as if sitting back, ensuring knees are aligned with toes. Rise back up by pushing through the heels, keeping a straight back for an effective leg and glute workout.',
        textAlign: TextAlign.center,
        style: TextStyle(
          color: Colors.black54,
          fontSize: 16,
