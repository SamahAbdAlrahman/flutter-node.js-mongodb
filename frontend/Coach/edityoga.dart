...
import '../configs.dart';
class addYogaExercises extends StatefulWidget {
  const addYogaExercises({super.key});

  @override
  State<addYogaExercises> createState() => _WorkoutDetailViewState();
}
class _WorkoutDetailViewState extends State<addYogaExercises> {
  ...
  Future<List<ExerciseItem>> fetchExercises() async {
    final apiUrl = Uri.parse('http://192.168.0.114:5000/yogaexercises'); // Replace with your API endpoint
  ...
  Future<void> deleteExercise(String exerciseId) async {
    final apiUrl = Uri.parse('http://192.168.0.114:5000/yoga/$exerciseId');
    try {
            ...
            SliverAppBar(
              ...
              flexibleSpace: Align(
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      "Edit Free Weight Lifting Exercises",
                      style: TextStyle(
                        color: Colors.white,
                        fontSize: 24,
                        ...
                        children: [
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                Text("Free Weight Lifting Exercises",
                                  style: TextStyle(
