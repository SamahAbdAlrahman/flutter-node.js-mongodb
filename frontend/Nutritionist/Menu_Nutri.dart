...
import 'AddMeal/explore.dart';


class MenuNutrui extends StatefulWidget {
  const MenuNutrui({super.key});
...
class _MenuNutruiState extends State<MenuNutrui> {
  int currentState = 0;
  List<Widget> widgets = [const MenuNutrui(), const ProfileScreen()];
  List<String> titleString = ["Nutritionist Page", "Profile Page"];
  ...
  void navigateBasedOnSearch(String query) {
    if (query.toLowerCase().contains('Nutrition programs') ) {
      ...
      // ));
    }  else if (query.toLowerCase().contains('chat') ||query.toLowerCase().contains('msg')) {
      // Navigator.of(context).push(MaterialPageRoute(
      //   builder: (context) => BMIView(),
      // )
      // );
    } else if ( query.toLowerCase().contains('new post')||query.toLowerCase().contains('add post')) {
      // Navigator.of(context).push(MaterialPageRoute(
              ...
              child: Padding(
                ...
                child: Text(
                  ...
                  TextStyle(color: Colors.white70,
                      fontFamily: ('inter'),fontSize: 24.6),
                ),
              ),
            ),
          ),
              ...
              Container(
                ...
                child: ListView(
                  ...
                  children: <Widget>[
                    ...
                    promoCard2('assets/images/n.jpg'),
                    promoCard1('assets/images/j.jpg'),
