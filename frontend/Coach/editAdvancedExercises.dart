...
import '../configs.dart';
class addAdvancedExercises extends StatefulWidget {
  const addAdvancedExercises({super.key});



  @override
  State<addAdvancedExercises> createState() => _WorkoutDetailViewState();

}

class _WorkoutDetailViewState extends State<addAdvancedExercises> {
  ...
  Future<void> deleteExercise(String exerciseId) async {
    final apiUrl = Uri.parse('http://192.168.0.105:5000/Advanced/$exerciseId');
    try {
