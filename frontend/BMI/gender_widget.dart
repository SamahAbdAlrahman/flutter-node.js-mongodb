        ...
        children: [
          ChoiceChip3D(
            height: 100,
              ...
              onUnSelected: () {},
              selected: _gender == 1,
              child:   Text("Male", textAlign: TextAlign.center,style: TextStyle(fontWeight: FontWeight.bold,fontSize: 18,))
    ),
          const SizedBox(
            width: 30,
          ),
          ChoiceChip3D(
            height: 100,
              ...
              selected: _gender == 2,
              onUnSelected: () {},
              child:   Text("Female", textAlign: TextAlign.center,style: TextStyle(fontWeight: FontWeight.bold,fontSize: 18,))
